...
?>
    ...
    <div class="inner-banner">
        <div class="container">
           <div class="banner-title">
                <h3>Sericulture <a href="#" class="changeTopic" data-toggle="collapse" data-target="#changeTopic">Change Topic</a></h3>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo site_url()?>/production-of-commercial-silk-cocoon/">Sericulture</a></li>
   ...
   <form method="post" action="<?php echo site_url()?>/sericulture-details/">
    <input type="hidden" name="sericulture_type" value="<?php echo $page_data->post_title;?>">
        ...
        <div class="container">
          <div class="national-level icon-text-box">
            ...
            <?php
                    ...
                    if($page_data->post_title == 'Production of Commercial Silk Cocoon')
                   { 
                     $icon_image ="silk-cocoon.png";
                     $heading='Production of Commercial Silk Cocoon';
                   }
                   else if($page_data->post_title == 'Production of Reeled Yarn')
                   { 
                     $icon_image ="yarn.png";
                     $heading='Production of Reeled Yarn';
                   }
                   else if($page_data->post_title == 'Fabric Production')
                   { 
                ...
                <div class="col-12 col-md-6 col-xl-4">
                  <div class="nf-select-wrap">
                    ...
                    <div class="nf-select-field">
                      <select class="form-control selectpicker" name="variety" id="variety">
                        ...
                        <?php
                          ...
                          <?php /* ?>
                        <?php //if($page_data->post_title=='Species Wise'){?>
                          <option value="Eri">Eri</option>
                          <option value="Muga">Muga</option>
                          <option value="Mulberry">Mulberry</option>
                          <option value="Oak Tasar">Oak Tasar</option>
                      <?php //}?>
                      <?php */ ?>
                      </select>
                    </div>
...
function validation_function()
   {
      ...
      var flag=true;
       ...
       {
           // alert('hjghj');
           error_msg1.textContent = "*Please select variety";
           flag= false;
       }
