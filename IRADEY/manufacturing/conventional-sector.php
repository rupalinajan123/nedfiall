<?php /*Template Name: Conventional Sector */ ?>
<?php get_header(); 
          ...
          <div class="collapse " id="changeTopic" style="">
            ...
            <div class="card card-body">
              <div class="row">
                  ...
                  <h4>Select topic</h4>
                    <ul>
                      <li><a href="<?php echo site_url();?>/automobiles-mechanical-steel-iron-metallurgical">Automobiles, Mechanical, Steel & Iron & Metallurgical</a></li>
                      <li><a href="<?php echo site_url();?>/chemicals-organic-inorganic-with-petroleum-products">Chemicals (Organic & Inorganic) with Petroleum Products</a></li>
                      <li><a href="<?php echo site_url();?>/electrical-electronics-computers-and-infotech-it-projects">Electrical & Electronics</a></li>
                      <li><a href="<?php echo site_url();?>/gums-and-adhesives">Gums & Adhesive</a></li>
                      <!--<li><a href="<?php //echo site_url();?>/infotech-it-projects">Infotech / It Projects</a></li>-->
                      <li><a href="<?php echo site_url();?>/leather-and-leather-products">Leather & Leather Products</a></li>
                      
                      <li><a href="<?php echo site_url();?>/paint-enamel-solvents-thiners-inks">Industrial & Decorative Paints</a></li>
                ...
                <div class="col-md-6">
                  <h4>&nbsp;</h4>
                    <ul>
                        <li><a href="<?php echo site_url();?>/textile">Textile</a></li>
                      <li><a href="<?php echo site_url();?>/plastic-bopp-acrylic-disposable-plastic-products-pet-products">Pet & Polymer Products</a></li>
                      

                      <li><a href="<?php echo site_url();?>/pharmaceutical-and-healthcare">Pharmaceutical & Healthcare</a></li>

                      <li><a href="<?php echo site_url();?>/pulp-paper-straw-grey-board">Pulp, Paper & Packaging</a></li>
                      <!--<li><a href="<?php //echo site_url();?>/infotech-it-hospitality-hospital-college-school-medical-entertainment">Infotech / It, Hospitality, Hospital, College, School, Medical, Entertainment, Club, Ware Housing & Real Estate Projects.</a></li>-->
                      <li><a href="<?php echo site_url();?>/miscellaneous">Miscellaneous</a></li>
                    </ul>
                </div>
...
<form method="post" action="<?php echo site_url()?>/conventional-sector-details/">
