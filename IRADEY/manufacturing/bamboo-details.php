<?php /*Template Name: Bamboo Details */
/* Template Post Type: Bamboo */
?>
<?php 
if($_POST['incense']=='')
{  
  ...
  <div class="container">
    <div class="banner-title">
      ...
      <ul class="breadcrumb">
        ...
        <!--<li class="breadcrumb-item active">Incense Sticks</li>-->
              ...
              <div class="row">
                  ...
                  <h4>Select topic</h4>
                    <ul>
                                ...
                                <li><a href="<?php echo site_url()?>/bamboo/floor-tiles/"> Engineered Wood</a></li>
                                ...
                                <li><a href="<?php echo site_url()?>/bamboo/bamboo-activated-carbon/"> Bamboo Activated Charcoal</a></li>
                ...
                <div class="col-md-6">
                  <h4>&nbsp;</h4>
                    <ul>
                                ...
                                <li><a href="<?php echo site_url()?>/bamboo/bamboo-string-lights/"> Lifestyle Product </a></li>
                                <li><a href="<?php echo site_url()?>/bamboo/bamboo-engineered-wood-based-tiles/"> Floor Tiles</a></li>
                                ...
                                <li><a href="<?php echo site_url()?>/bamboo/bamboo-furniture/"> Bamboo Furniture  </a></li>
                                <li><a href="<?php echo site_url()?>/bamboo/bamboo-mat-board/"> Bamboo Mat Board  </a></li>
                    </ul>
                </div>
