                ...
                <div class="megamenu">
                  ...
                  <div class="megamenu-row">
                    ...
                    <li>
                      ...
                      <a class="box" href="<?php echo site_url()?>/career_type/new-age-career/">
                        ...
                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/megamenu/new-icon-gif-4.gif" height="50px" width="50px">
              ...
              <li>
                  ...
                  <li><a href="#">Higher Education India</a>
                    ...
                    <li>
                          ...
                          <a class="box" href="<?php echo site_url()?>/higher-education-india-list/New-Age-Career/">
                              ...
                              <div class="tab-pane fade" id="nf-protab5" role="tabpanel">
                                ...
                                <div class="mega-panel-sec lg-size">
                                 ...
                                 <?php /* ?>
                                  ...
                                  <div class="panel"><a href="<?php echo site_url()?>/map/agar-aquilaria-agallocha"><div class="panel-body nf-brlf1"> Agar <span>(Aquilaria agallocha)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/patchouli-pogostemon-cablin"><div class="panel-body nf-brlf2"> Patchouli <span>(Pogostemon cablin)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/stevia-stevia-rebaudiana"><div class="panel-body nf-brlf3"> Stevia <span>(Stevia rebaudiana)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/lemongrass-cymbopogon-flexuosus"><div class="panel-body nf-brlf4"> Lemongrass <span>(Cymbopogon flexuosus)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/citronella-cymbopogon-winterianus"><div class="panel-body nf-brlf5"> Citronella <span>(Cymbopogon winterianus)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/vetiver-vetiveria-zizaniodes"><div class="panel-body nf-brlf6"> Vetiver <span>(Vetiveria zizaniodes)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/sugandhmantri-gondhi-homalomena-aromatica"><div class="panel-body nf-brlf1"> Sugandhmantri / Gondhi <span>(Homalomena aromatica)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/sarpagandha-rauvolfia-serpentina-family-apocynaceae"><div class="panel-body nf-brlf2"> Sarpagandha <span>(Rauvolfia serpentina, Family: Apocynaceae)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/tulshi-ocimum-tenuiflorum"><div class="panel-body nf-brlf3"> Tulshi <span>(Ocimum tenuiflorum)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/brahmi-bacopa-monnieri"><div class="panel-body nf-brlf4"> Brahmi <span>(Bacopa monnieri)</span> </div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/ghritkumari-aloe-vera"><div class="panel-body nf-brlf5"> Ghritkumari <span>(Aloe vera)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/pipli"><div class="panel-body nf-brlf5"> Pipli <span>(Piper longum)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/rosemary-rosemarinus-officinalis"><div class="panel-body nf-brlf1"> Rosemary <span>(Rosemarinus officinalis)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/coleus-coleus-forskohlii"><div class="panel-body nf-brlf2"> Coleus <span>(Coleus forskohlii)</span> </div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/kokum-garcinia-indica"><div class="panel-body nf-brlf3"> Kokum <span>(Garcinia indica)</span></div></a></div>

                                  <div class="panel"><a href="<?php echo site_url()?>/map/curry-leaves-murraya-koenigii"><div class="panel-body nf-brlf4"> Curry leaves <span>(Murraya koenigii)</span></div></a></div>
                          ...
                          <div class="tab-content" id="nf-mnfctr-Content">
                            ...
                            <div class="tab-pane fade" id="nf-mnfctrtab3" role="tabpanel">
                              ...
                              <div class="mega-panel-sec lg-size">
                                ...
                                <div class="panel"><a href="<?php echo site_url()?>/bamboo/manufacturing-briquettes-or-white-coal-from-bamboo-agro-waste-saw-dust/"><div class="panel-body nf-brlf2"> Manufacturing Briquettes or White coal from bamboo/ agro-waste/ saw dust  </div></a></div>
                                <div class="panel"><a href="<?php echo site_url()?>/bamboo/bamboo-fiber/"><div class="panel-body nf-brlf4"> Bamboo Fiber  </div></a></div>
