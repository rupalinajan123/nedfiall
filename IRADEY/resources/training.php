...
<?php get_header();
$page_data = get_page_by_path( 'training_page' );
?>
  ...
  <form method="post" action="<?php echo site_url()?>/training-details/">
          ...
          <div class="row">
             ...
             <!--  <label>Find Internship by Location</label> -->
              <div class="nf-select-wrap">
                ...
                <div class="nf-select-field">
                   <?php 
                      $var = get_field_object('field_60cc9978f90b7');
                      ?>
            ...
            <div class="col-12 col-md-6 col-xl-4">
              ...
              <div class="nf-select-wrap">
                ...
                <div class="nf-select-field">
                  <?php 
                      $var = get_field_object('field_60cc9cbc03192');
                    ?>
