<?php /*Template Name: Apps & Journals*/ ?>
<?php get_header();
...
?>  
  ...
  <form method="post" action="<?php echo site_url()?>/apps-journal-details/">
             ...
             <div class="col-12 col-md-6 col-xl-4">
              ...
              <div class="nf-select-wrap">
                ...
                <div class="nf-select-field">
                    <?php 
                      $var = get_field_object('field_60cdd5fa4bb7e');
                      ?>
              ...
              <div class="nf-select-wrap">
                <div class="nf-select-img">
                  <img src="<?php echo get_template_directory_uri(). '/assets/'?>img/entrepreneurship-and-resources/platform.png" alt="platform">
                  <span>Platform</span>
                </div>
                <div class="nf-select-field">
                     <?php 
                      $var = get_field_object('field_60cdd63f4bb7f');
                    ?>
                  <select class="form-control selectpicker" name="platform" id="platform">
