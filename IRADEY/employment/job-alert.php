<?php /*Template Name: Job Alert */ ?>
<?php get_header(); 

$page_data = get_page_by_path( 'job-alert' );
?>
<!doctype html>
  ...
  <div class="inner-banner">
    <div class="container">
      <div class="banner-title">
        <h3>Job Alert <!-- <a href="#" class="changeTopic">Change Exam</a> --></h3>
        <ul class="breadcrumb">
  ...
  <form method="post" action="<?php echo site_url()?>/job-alert-details/">
             ...
             <!--  <label>Select Options</label> -->
              <div class="nf-select-wrap">
                ...
                <div class="nf-select-field">
                  <?php 
                      $var = get_field_object('field_60d31343fc238');
                      ?>
...
function validation_function()
   {
      ...
      var flag=true;
       ...
       {
           // alert('hjghj');
           error_msg1.textContent = "*Please select sector";
           flag= false;
       }
