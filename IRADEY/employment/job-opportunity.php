<?php /*Template Name: Job opportunity */ ?>
<?php get_header(); 

$page_data = get_page_by_path( 'job-opportunity' );
?>
  ...
  <form method="post" action="<?php echo site_url()?>/job-opportunity-details">
             ...
             <!--  <label>Select Options</label> -->
              <div class="nf-select-wrap">
                ...
                <div class="nf-select-field">
                  <?php 
                      $var = get_field_object('field_60d31d4ad0c54');
                      ?>
