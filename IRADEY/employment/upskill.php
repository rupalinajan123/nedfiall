<?php /*Template Name: Upskill */ ?>
<?php get_header(); 

$page_data = get_page_by_path( 'upskill' );
?>
        ...
        <div class="banner-content">
          <div class="row">
            ...
            <div class="col-md-8  pl-0">
              <div class="bannerbg nf-gradient-upskill justify-content-start pt-3 nf-height-100">
    ...
    <form method="post" action="<?php echo site_url()?>/upskill-details/">
    <div class="inner-body">
      <div class="container">
        <div class="national-level icon-text-box">
          ...
          <?php/*?><div class="nf-form-wrap">
    <div class="row">

      <?php
          $var = get_field_object('field_60cd7d52ed7e6');
      ...
      ?>
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="nf-radio-wrap mb-4">
                        <div class="custom-control custom-radio custom-control-inline pl-0">
                            <input type="radio" id="customRadioInline<?php echo $k?>" name="level" class="custom-control-input" value="<?php echo $choice;?>" <?php if($k==1) //echo 'checked'; ?>>
        ...
        <?php }?>        
           ...
           <!-- <div class="col-12 col-md-6 col-xl-3">
                <div class="nf-radio-wrap mb-4">
                    <div class="custom-control custom-radio custom-control-inline pl-0">
                        <input type="radio" id="customRadioInline2" name="mentorsAndIncubators" class="custom-control-input" value="incubators">
                        <label class="custom-control-label" for="customRadioInline2">State Level</label>
                    </div>
                </div> 
            </div> -->
            </div>
             ...
             <!--  <label>Select Options</label> -->
              <div class="nf-select-wrap">
                ...
                <div class="nf-select-field">
                  <?php 
                      $var = get_field_object('field_60cc9a861aae5');
                      ?>
                      <select class="form-control selectpicker" name="sector">
