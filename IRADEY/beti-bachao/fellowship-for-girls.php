<?php /* Template Name: Fellowship for Girls */
 ?>
<?php get_header();  
...
$page_data = get_page_by_path( 'fellowship-for-girls' );
?>
    ...
    <form method="post" action="<?php echo site_url()?>/fellowship-for-girls-list/">
      <input type="hidden" name="region" id="region" value="India">
        ...
        <div class="national-level icon-text-box">
          ...
          <div class="nf-navtab-sec nf-felloship">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="pill" href="#pills-india" onclick="document.getElementById('region').value = 'India'"><img src="<?php echo get_template_directory_uri(). '/assets/'?>img/education/india-sm.png" alt="India Map"> India</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="pill" href="#pills-india" onclick="document.getElementById('region').value = 'Abroad'"><img src="<?php echo get_template_directory_uri(). '/assets/'?>img/education/abroad-sm.png"> Abroad</a>
              </li>
            </ul>
            <div class="" id="pills-tabContent"> <!--tab-content-->
                      ...
                      <div class="nf-select-wrap">
                        ...
                        <div class="nf-select-field">
                          <?php 
                              ...
                              ?>
                              <select class="form-control selectpicker" name="category_of_fellowship">
