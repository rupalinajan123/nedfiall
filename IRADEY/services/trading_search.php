<?php /*Template Name: Services-Trading-Search*/ ?>
<?php 
get_header(); 
          ...
          <div class="collapse " id="changeTopic" style="">
            ...
            <div class="card card-body">
              <div class="row">
                  ...
                  <h4>Select topic</h4>
                    <ul>
                      <li><a href="<?php echo site_url()?>/garments">Garments</a></li>
                      <li><a href="<?php echo site_url()?>/electronics">Electronics</a></li>
                      <li><a href="<?php echo site_url()?>/accessories">Accessories </a></li>
                      <li><a href="<?php echo site_url()?>/food"> Food </a></li>
                    </ul>
                </div>
                <div class="col-md-6">
                  <h4>&nbsp;</h4>
                    <ul>
                      <li><a href="<?php echo site_url()?>/sports-and-fitness">Sports and Fitness</a></li>
                      <li><a href="<?php echo site_url()?>/general">General</a></li>
                      <li><a href="<?php echo site_url()?>/stores"> Stores </a></li>
                      <li><a href="<?php echo site_url()?>/service-unit"> Service Unit </a></li>
...
<form method="post" action="<?php echo site_url()?>/trading-details/">
  <input type="hidden" name="trading_type" value="<?php echo $page_data->post_title;?>">
    ...
    <div class="col-12 col-md-6 col-xl-4">
      <div class="nf-select-wrap">
        ...
        <div class="nf-select-field">
          <select class="form-control selectpicker" name="trading" id="trading">
...
function validation_function()
   {
      ...
      var flag=true;
       ...
       {
           // alert('hjghj');
           error_msg1.textContent = "*Please Select Project";
           flag= false;
       }
       return flag;
       }
