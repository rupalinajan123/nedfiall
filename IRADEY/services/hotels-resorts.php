<?php /*Template Name: Hotels and Resorts */ ?>
<?php get_header(); 
...
<form method="post" id="form" action="<?php echo site_url()?>/other-details/" >
    ...
    <div class="col-12 col-md-6 col-xl-4">
      <div class="nf-select-wrap">
        <div class="nf-select-img">
          <img src="<?php echo get_template_directory_uri(). '/assets/'?>img/entreprenuearship/hotels.png" alt="Hotels">
          <span>Hotels</span>
        </div>
        <div class="nf-select-field">
          <select class="form-control selectpicker" name="internet_service" id="internet_service">
            <option value="">Select Type of Hotels & Resorts</option>
